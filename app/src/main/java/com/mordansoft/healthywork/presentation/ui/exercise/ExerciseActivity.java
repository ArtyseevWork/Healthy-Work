...
public class ExerciseActivity extends AppCompatActivity {
    ...
    private void init(){
        ...
        vm = new ViewModelProvider(this,
                    new ExerciseViewModelFactory(this))
                .get(ExerciseViewModel.class);
        vm.getExercise(exerciseId).observe(this, exerciseObserver);
    ...
    View.OnClickListener btnDeleteListener = v -> {
        //Exercise.deleteExercise(v.getContext(), exercise); //ca
